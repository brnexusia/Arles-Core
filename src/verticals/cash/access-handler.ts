...
export class CashAccessHandler implements VerticalHandler {
  async handle(context: VerticalContext): Promise<VerticalResult | null> {
    ...
    // Camada complementar para frases comuns que escapam dos parsers especializados.
    // Ela apenas reescreve/delega para motores seguros; não calcula nem persiste sozinha.
    ...
    // O GPT só entra depois de agenda, cofrinhos, linguagem determinística, saldo,
    // simulação, exclusões, FAQ e do corpus interno do AiFirstHandler.
